...
export function RegistrationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err?.data?.message || err?.message || 'Registration failed. Try again.');
    }
  };
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative', overflow: 'hidden', background: '#714012', containerType: 'inline-size' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Name */}
        <div style={{ width: '32.05cqw', height: 0, left: '63.37cqw', top: '21.29vh', position: 'absolute', outline: '5px #714012 solid', outlineOffset: '-2.50px' }} />
        <label style={{ left: '63.37cqw', top: '16.11vh', position: 'absolute', opacity: form.name ? 0 : 0.80, color: 'black', fontSize: '2.93vh', fontFamily: 'Klee One', fontWeight: '600', wordWrap: 'break-word', pointerEvents: 'none' }}>
          Name
        </label>
        <input
          name="name" value={form.name} onChange={handleChange}
        ...
        {/* Email */}
        <div style={{ width: '32.05cqw', height: 0, left: '63.37cqw', top: '32.03vh', position: 'absolute', outline: '5px #714012 solid', outlineOffset: '-2.50px' }} />
        <label style={{ left: '63.37cqw', top: '26.86vh', position: 'absolute', opacity: form.email ? 0 : 0.80, color: 'black', fontSize: '2.93vh', fontFamily: 'Klee One', fontWeight: '600', wordWrap: 'break-word', pointerEvents: 'none' }}>
          Email
        </label>
        <input
          name="email" type="email" value={form.email} onChange={handleChange}
        ...
        {/* Phone */}
        <div style={{ width: '32.05cqw', height: 0, left: '63.37cqw', top: '42.77vh', position: 'absolute', outline: '5px #714012 solid', outlineOffset: '-2.50px' }} />
        <label style={{ left: '63.37cqw', top: '37.60vh', position: 'absolute', opacity: form.phone ? 0 : 0.80, color: 'black', fontSize: '2.93vh', fontFamily: 'Klee One', fontWeight: '600', wordWrap: 'break-word', pointerEvents: 'none' }}>
          Phone
        </label>
        <input
          name="phone" type="tel" value={form.phone} onChange={handleChange}
          style={{ width: '32.05cqw', left: '63.37cqw', top: '37.60vh', position: 'absolute', background: 'transparent', border: 'none', outline: 'none', color: 'black', fontSize: '2.93vh', fontFamily: 'Klee One', fontWeight: '600', opacity: 1 }}
        />

        {/* Password */}
        <div style={{ width: '32.05cqw', height: 0, left: '63.37cqw', top: '53.52vh', position: 'absolute', outline: '5px #714012 solid', outlineOffset: '-2.50px' }} />
        <label style={{ left: '63.37cqw', top: '48.34vh', position: 'absolute', opacity: form.password ? 0 : 0.80, color: 'black', fontSize: '2.93vh', fontFamily: 'Klee One', fontWeight: '600', wordWrap: 'break-word', pointerEvents: 'none' }}>
          Password
        </label>
        <input
          name="password" type="password" value={form.password} onChange={handleChange}
          style={{ width: '32.05cqw', left: '63.37cqw', top: '48.34vh', position: 'absolute', background: 'transparent', border: 'none', outline: 'none', color: 'black', fontSize: '2.93vh', fontFamily: 'Klee One', fontWeight: '600', opacity: 1 }}
        />
        ...
        {error && (
          <p style={{ width: '32.05cqw', left: '63.37cqw', top: '67.20vh', position: 'absolute', color: '#B00020', fontSize: '1.70vh', fontFamily: 'Klee One', fontWeight: '600', wordWrap: 'break-word' }}>
            {error}
          </p>
        )}
      </form>
